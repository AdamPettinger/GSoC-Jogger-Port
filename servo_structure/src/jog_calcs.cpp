...
JogCalcs::JogCalcs(const rclcpp::NodeOptions & options)
  : Node("jog_calcs", options), latest_joint_state_(0.0), 
  latest_collision_scale_(0.0), latest_twist_cmd_(0.0), latest_joint_cmd_(0.0)
{
  ...
  collision_scaling_sub_ = joint_state_sub_ = this->create_subscription<std_msgs::msg::Float64>(
...
{
  std::cout << "[Calcs] Heard message with jointStateCB, value = " << msg->data << ". Address was " << &msg << std::endl;
...
{
  std::cout << "[Calcs] Heard message with collisionScaleCB, value = " << msg->data << ". Address was " << &msg << std::endl;
...
{
  std::cout << "[Calcs] Heard message with twistCmdCB, value = " << msg->data << ". Address was " << &msg << std::endl;
...
{
  std::cout << "[Calcs] Heard message with jointCmdCB, value = " << msg->data << ". Address was " << &msg << std::endl;
